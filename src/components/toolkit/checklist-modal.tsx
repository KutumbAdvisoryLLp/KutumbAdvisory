        ...
        >
          <div className="sticky top-0 bg-white z-10 flex items-center justify-between px-4 py-4 sm:px-6 sm:py-5 border-b border-slate-lighter/10 shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-guru/20 to-guru/5 flex items-center justify-center shrink-0">
                <ToolIcon id={checklist.id} className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <div>
                <h2 className="font-serif text-lg sm:text-xl text-navy">{checklist.title}</h2>
